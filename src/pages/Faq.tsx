...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <style>{`
        /* Membuat semua FAQ item memiliki tinggi minimum yang sama */
        .faq-item-wrapper {
          min-height: 110px;
          display: flex;
        ...
        /* Memastikan button pertanyaan mengisi ruang yang tersedia */
            ...
            <div className="faq-item-wrapper">
              <FAQItem
                ...
                answer={
                  currentLang === "id" ? (
                    <>
                      <p>Tidak bisa, karena kami menggunakan jasa ilustrator dan desainer. Setelah pembayaran, kirim referensi foto atau sketsa agar sesuai keinginan.</p>
                      <a
